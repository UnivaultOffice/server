  ...
  return (
    <div className={styles.loginContainer}>
      <div className={styles.loginCard}>
        <h1 className={styles.title}>UNIVAULTOFFICE Admin Panel</h1>
        ...
        <div className={styles.descriptionContainer}>
          ...
          <p className={styles.description}>
            ...
            <a
              href='https://helpcenter.univaultoffice.github.io/docs/installation/docs-admin-panel.aspx#passwordresetrecovery_block'
              target='_blank'
